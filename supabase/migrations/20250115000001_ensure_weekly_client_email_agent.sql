-- Ensure Weekly Client Email Agent exists (idempotent)
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE NOTICE 'Skipping 20250115000001: ai_agents table not yet created, will be seeded by later migrations.';
    RETURN;
  END IF;
